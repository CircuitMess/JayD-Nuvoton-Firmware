...
/*  ENCODER A & B PINS  */
// center
#define ENCODER0_A P15
#define ENCODER0_B P33
// left-up
#define ENCODER1_A P31
#define ENCODER1_B P30
// right-down
#define ENCODER2_A P56
#define ENCODER2_B P55
// right-middle
#define ENCODER3_A P53
#define ENCODER3_B P52
// right-up
#define ENCODER4_A P50
#define ENCODER4_B P27
// left-down
#define ENCODER5_A P4^6
#define ENCODER5_B P14
// left-middle
#define ENCODER6_A P22
...
#define ENC_A_B_INIT() do{P15_Quasi_Mode;P33_Quasi_Mode;P31_Quasi_Mode;P30_Quasi_Mode;P56_Quasi_Mode;P55_Quasi_Mode; \
						  P53_Quasi_Mode;P52_Quasi_Mode;P50_Quasi_Mode;P27_Quasi_Mode;P46_Quasi_Mode;P14_Quasi_Mode; \
						  P22_Quasi_Mode;P21_Quasi_Mode;ENC_SCHMITT_TRIGGER_INPUT;}while(0)
