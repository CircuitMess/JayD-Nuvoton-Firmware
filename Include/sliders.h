...
#define		ADC_CLK_DIV		ADCCON1&=0x0F
#define		ADC_ACQ				ADCAQT&=0x00
#define		ADC_ENABLE		ADCCON1|=SET_BIT0
#define		ADC_DISABLE		ADCCON1&=~SET_BIT0

/*	SLIDER INIT	*/
#define		INIT_ADC_SLIDER0()		do{	ADCCON1&=~SET_BIT0; SLIDER0_CH;	P06_Input_Mode; P0DIDS&=0x00; P0DIDS|=SET_BIT6; ADCCON1|=SET_BIT0;}while(0)
#define		INIT_ADC_SLIDER1()		do{	ADCCON1&=~SET_BIT0; SLIDER1_CH;	P05_Input_Mode; P0DIDS&=0x00; P0DIDS|=SET_BIT5; ADCCON1|=SET_BIT0;}while(0)
#define		INIT_ADC_SLIDER2()		do{	ADCCON1&=~SET_BIT0; SLIDER2_CH;	P04_Input_Mode; P0DIDS&=0x00; P0DIDS|=SET_BIT4; ADCCON1|=SET_BIT0;}while(0)
